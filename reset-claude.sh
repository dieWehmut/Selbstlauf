...
IMPLEMENTATION="$SCRIPT_DIR/scripts/uninstall/linux/reset-claude.sh"
if [ -f "$IMPLEMENTATION" ]; then
  exec /bin/bash "$IMPLEMENTATION" "$@"
fi

REMOTE_URL="https://raw.githubusercontent.com/dieWehmut/Selbstlauf/main/scripts/uninstall/linux/reset-claude.sh"
